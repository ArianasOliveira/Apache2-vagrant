...
Vagrant.configure("2") do |config|
  ...
  git clone https://github.com/ArianasOliveira/introducao-html-css.git/var/www/introducao-html-css
  git clone https://github.com/ArianasOliveira/Apache2-vagrant.git/etc/apache2/sites-enable
  # git clone https://github.com/mattdesl/simple-html-index.git /var/www/simple-html-index
  rm /etc/apache2/sites-enabled/000-default.conf
  git clone https://github.com/ArianasOliveira/Apache2-vagrant.git /etc/apache2/sites-enabled
